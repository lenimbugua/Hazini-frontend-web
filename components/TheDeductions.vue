        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-200">
                <tr class="divide-x divide-gray-300">
                    ...
                    <th scope="col" class="py-3 px-6">Amount Expected</th>
                    <th scope="col" class="py-3 px-6">Amount Deducted </th>
                    <th scope="col" class="py-3 px-6">Period From</th>
                    <th scope="col" class="py-3 px-6">Period To</th>
                    <th scope="col" class="py-3 px-6">Status</th>
                    <th scope="col" class="py-3 px-6">Actioned At</th>
                </tr>
            </thead>
